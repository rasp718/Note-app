                        ...
                        return (
                            <React.Fragment key={msg.id}>
                                ...
                                {!isMe && (
                                    ...
                                    {/* TAIL SVG - Sent (Right) - Seamless Overlay (z-20) */}
                                    {isMe && isLastInGroup && !msg.imageUrl && (
                                        <svg className="absolute bottom-[1px] -right-[8px] rotate-[6deg] z-20 w-[17px] h-[14px] fill-current" viewBox="0 0 17 14">
                                            <path d="M0,0 C2,7.5 9,14 17,14 H0 V0 Z" fill={tailColor} />
                                        </svg>
                                    )}

                                    {/* TAIL SVG - Received (Left) - Seamless Overlay (z-20) */}
                                    {!isMe && isLastInGroup && !msg.imageUrl && (
                                        <svg className="absolute bottom-[1px] -left-[8px] rotate-[-6deg] z-20 w-[17px] h-[14px] fill-current" viewBox="0 0 17 14">
